namespace Cik.Framework.Domain
{
    ...
    /// <summary>
    /// The base class of Entity, that permits the entity can composite with 2 or more ids. 
    /// 
    /// We can use it like SampleEntity : EntityWithCompositeId. Reference more at <see cref = "EntityWithCompositeId" />
    /// </summary>
